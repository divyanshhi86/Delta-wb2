...
import { 
  ...
  CheckCircle2, Truck, RefreshCcw, MessageSquare, Box
} from 'lucide-react';
...
function CoursesView() {
  const courses = [
    { title: "Computer Basics", icon: <Cpu />, color: "bg-slate-50 text-slate-600", duration: "3 Months" },
    { title: "Graphic Design", icon: <PenTool />, color: "bg-slate-50 text-slate-600", duration: "6 Months" },
    { title: "Tally & Accounting", icon: <BookOpen />, color: "bg-slate-50 text-slate-600", duration: "4 Months" },
    { title: "Web Development", icon: <Cpu />, color: "bg-slate-50 text-slate-600", duration: "6 Months" },
    { title: "Digital Marketing", icon: <Search />, color: "bg-slate-50 text-slate-600", duration: "3 Months" },
    { title: "Soft Skills", icon: <User />, color: "bg-slate-50 text-slate-600", duration: "2 Months" }
  ];
    ...
    <div className="bg-slate-50 min-h-screen">
      <section className="bg-slate-900 py-16 px-4 md:px-8 text-center text-white relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-4">
          ...
          <p className="text-slate-400 max-w-xl mx-auto">Empowering students with quality education and professional skill development programs.</p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {courses.map((s, i) => (
            <motion.div 
              key={i}
              whileHover={{ y: -5 }}
              className="bg-white p-8 rounded-3xl border border-black/5 soft-shadow group"
            >
